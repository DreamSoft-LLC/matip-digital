            ...
            <div className="flex-1 container mx-auto">
                <div>
                    <h1 className="text-4xl font-bold pt-5 text-center my-5">
                        <span className="border-blue-500 uppercase ">Contact <span className="text-blue-500">Us</span> </span>
                    </h1>
                    <div className="text-center font-semibold ">
                        <Link to="/">Home</Link> <span className="px-3">/</span> <Link to='/contact' className="text-blue-500">Contact</Link>
                    </div>
                </div>
                <div>
                            ...
                            <div className="flex flex-col md:flex-row space-y-5 items-center justify-center pt-5 space-x-5">
                                <div className="flex items-center space-x-2">
                                    <span className="border-blue-500 border-2 rounded-full p-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="text-blue-700 h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
